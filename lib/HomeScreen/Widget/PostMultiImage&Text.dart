...
class PostMultiImageText extends StatefulWidget {
  String title;
  String imageUser;
  String userName;
  String commentNmb;
  ...
  PostMultiImageText(
      {this.title,
        ...
        this.likeNumb});
  @override
  _PostMultiImageTextState createState() => _PostMultiImageTextState();
}
class _PostMultiImageTextState extends State<PostMultiImageText> {
  bool isLike=false;
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.center,
                ...
                Padding(
                  ...
                  child: Container(
                    width: MediaQuery.of(context).size.width/2-10,
                    decoration: BoxDecoration(
                        image: DecorationImage(image: NetworkImage(widget.image2)
                            ,fit: BoxFit.cover)
                    ),
                  ),
                ),
